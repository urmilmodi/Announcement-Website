...
function login() {
    ...
    if (username === "" || password === "") {
        ...
        if (window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Login.HTML") {
            window.location.href = "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Create%20Announcements.HTML"; // Redirecting to Create Announcements
        } else {
            window.location.href = "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/View%20Announcements.HTML";
        }
    } else {
...
function setSettingsData() {
    ...
    // Displaying Settings
    if (window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Settings.HTML" || window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Student%20Settings.HTML") {
...
function getData() {
    ...
    if (window.confirm("Are you sure about this Announcement?")) {
        ...
        window.location.href = "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/View%20Announcements.HTML"; // Redirecting to View Announcements
    }
}
...
function showData() {
    ...
    for (Index = 0; Index < Post.length; Index++) {
        ...
        if (((SGender === Post[Index].Gender || Post[Index].Gender === "Both") && (SGrade === Post[Index].Grade || Post[Index].Grade === "All Grades") && (SCategory.includes(Post[Index].Category) || (Post[Index].Category === "All Categories" && SCategory !== "NoneNone") || (Post[Index].Category === "IBT" && IBT === "Yes") || SCategory.includes("All Categories")) && (SClubTeam.includes(Post[Index].ClubTeam) || (Post[Index].ClubTeam === "All Clubs/Teams" && SClubTeam !== "NoneNoneNone") || SClubTeam.includes("All Clubs/Teams"))) || Post[Index].Importance === "Yes" || Post[Index].Category === "Guidance") {
            ...
            if (Search !== null || Search !== "") {
                ...
                if ((temp.toUpperCase()).includes(Search.toUpperCase())) {
                    ...
                    if (window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/View%20Announcements.HTML") {
    ...
    if (Present === Past) {
        ...
        // Checks If Student or Teacher
        if (window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Student%20View%20Announcements.HTML") {
...
function editData() {
    ...
    if (window.location.href === "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Create%20Announcements.HTML") {
        ...
        if (Number(document.getElementById("editValue").value) > 0 && Number(document.getElementById("editValue").value) < Post.length) {
            ...
            window.location.href = "file:///C:/Users/Urmil%20Modi/School/Work/Grade%2011/Semester%201/ICS/1.%20Announcement%20App-Website/Code/Create%20Announcements.HTML";
        } else {
            edit = false;
        }
